...
class IMU:
    ...
    def read(self,reg):
        val = list(i2c.readfrom_mem(self._addr, reg,1))[0]

        return val

    def write(self,reg,value):

        i2c.writeto_mem(self._addr,reg,bytearray([value]))
    ...
    def read_bytes(self, reg, length=1):
        ...
        return list(i2c.readfrom_mem(self._addr, reg,length))
    ...
    def read_accelerometer_gyro_data(self):
        ...
        return ulab.array([ax, ay, az, gx, gy, gz])
